...
| `success.mp3` | Action completed -- also plays once the title-screen code is entered correctly |
...
| `correct_password_entry.mp3` | A correct digit entered in the title-screen code |
| `failed_password_entry.mp3` | A wrong digit entered in the title-screen code |
